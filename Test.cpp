...
TEST_CASE("All Noses"){
    ...
    // N
    CHECK(nospaces(snowman(11341234)) == nospaces("\n _===_ \n(...)\n(O,-)\n<(> <)/\n(   )"));
    CHECK(nospaces(snowman(12341321)) == nospaces("\n _===_ \n(...)\n(O.-)\n<(] [)\\n( : )"));
    CHECK(nospaces(snowman(23324123)) == nospaces("  ___  \n ..... \n(O_o)\n( : )>\n(___)"));
    CHECK(nospaces(snowman(14123212)) == nospaces("\n _===_ \n(...)\n(. o)\n/(] [)/\n(\" \")"));
}    

TEST_CASE("All Left Eyes"){

    // L
    CHECK(nospaces(snowman(11141234)) == nospaces("\n _===_ \n(...)\n(.,-)\n<(> <)/\n(   )"));
    CHECK(nospaces(snowman(12241321)) == nospaces("\n _===_ \n(...)\n(o.-)\n<(] [)\\n( : )"));
    CHECK(nospaces(snowman(23324123)) == nospaces("  ___  \n ..... \n(O_o)\n( : )>\n(___)"));
    CHECK(nospaces(snowman(14423212)) == nospaces("\n _===_ \n(...)\n(- o)\n/(] [)/\n(\" \")"));
}    

TEST_CASE("All Right Eyes"){

    // R
    CHECK(nospaces(snowman(11111234)) == nospaces("\n _===_ \n(...)\n(.,.)\n<(> <)/\n(   )"));
    CHECK(nospaces(snowman(12221321)) == nospaces("\n _===_ \n(...)\n(o.o)\n<(] [)\\n( : )"));
    CHECK(nospaces(snowman(23334123)) == nospaces("  ___  \n ..... \n(O_O)\n( : )>\n(___)"));
    CHECK(nospaces(snowman(11443212)) == nospaces("\n _===_ \n(...)\n(-,-)\n/(] [)/\n(\" \")"));
}    
...
TEST_CASE("All Left Arms"){
    ...
    // X
    CHECK(nospaces(snowman(11111234)) == nospaces("\n _===_ \n(...)\n(.,.)\n<(> <)/\n(   )"));
    CHECK(nospaces(snowman(12222321)) == nospaces("\n _===_ \n(...)\n(o.o)\n\\(] [)\\n( : )"));
    CHECK(nospaces(snowman(23333123)) == nospaces("  ___  \n ..... \n(O_O)\n/( : )>\n(___)"));
    CHECK(nospaces(snowman(11444212)) == nospaces("\n _===_ \n(...)\n(-,-)\n(] [)/\n(\" \")"));
}    
    
TEST_CASE("All Right Arms"){

    // Y
    CHECK(nospaces(snowman(11311134)) == nospaces("\n _===_ \n(...)\n(O,.)\n<(> <)>\n(   )"));
    CHECK(nospaces(snowman(12221221)) == nospaces("\n _===_ \n(...)\n(o.o)\n<(] [)/\n( : )"));
...
TEST_CASE("All Torsos"){
    ...
    // T
    CHECK(nospaces(snowman(11311114)) == nospaces("\n _===_ \n(...)\n(O,.)\n<( : )>\n(   )"));
    CHECK(nospaces(snowman(12221221)) == nospaces("\n _===_ \n(...)\n(o.o)\n<(] [)/\n( : )"));
    CHECK(nospaces(snowman(23133333)) == nospaces("  ___  \n ..... \n(._O)\n/(> <)\\\n(___)"));
    CHECK(nospaces(snowman(11143442)) == nospaces("\n _===_ \n(...)\n(.,-)\n/(   )\n(\" \")"));
}    

TEST_CASE("All Bases"){

    // B
    CHECK(nospaces(snowman(11311211)) == nospaces("\n _===_ \n(...)\n(O,.)\n<( : )/\n( : )"));
    CHECK(nospaces(snowman(12221222)) == nospaces("\n _===_ \n(...)\n(o.o)\n<(] [)/\n(\" \")"));
    CHECK(nospaces(snowman(23133233)) == nospaces("  ___  \n ..... \n(._O)\n/(> <)/\n(___)"));
    CHECK(nospaces(snowman(11143144)) == nospaces("\n _===_ \n(...)\n(.,-)\n/(   )>\n(   )"));
...
TEST_CASE("Bad snowman code: invalid letter") { 
    ...
    CHECK_THROWS(snowman(11234353));
    CHECK_THROWS(snowman(56789005));
    CHECK_THROWS(snowman(14232319));
}